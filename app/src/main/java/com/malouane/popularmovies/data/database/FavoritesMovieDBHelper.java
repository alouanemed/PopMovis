...
import com.malouane.popularmovies.data.database.FavoritesMovieContract.FavoritesMovies;
...
public class FavoritesMovieDBHelper extends SQLiteOpenHelper {
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        db.execSQL("DROP TABLE IF EXISTS " + FavoritesMovieContract.FavoritesMovies.TABLE_NAME);
        onCreate(db);
    }
}